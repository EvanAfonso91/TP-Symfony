 ...
 */
final class Version20250122130546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicle ADD registration_number VARCHAR(20) NOT NULL, ADD type VARCHAR(20) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE vehicle DROP registration_number, DROP type');
    }
}
